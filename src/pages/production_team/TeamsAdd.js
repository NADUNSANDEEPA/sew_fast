...
const TeamsAdd = ({navigation}) => {
    ...
    const handleSubmitAdd = (e) => {
        ...
        Alert.success('Added!', 'The item has been added.')
        ...
        <Box sx={{ flex: 1 }}>
            ...
            <BackgroundMaskComponent>
                ...
                <Card sx={{ marginTop: '5%', paddingBottom: '40%' }}>
                    <CardTitle sx={{ textAlign: "center", textDecoration: "underline" }} >Add New Team</CardTitle>

                    <DataForm onSubmit={handleSubmitAdd} isShadow={false}>
